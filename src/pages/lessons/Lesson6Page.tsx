...
`}</CodeBlock>
        ...
        <p>
            ...
            keeping track of who has accessed a document can be performed by always adding the user
            to the set when they access it.
        </p>
...
`}</CodeBlock>
        ...
        <p>
            You should use a Map when you need to store key/value pairs and the keys are not always
            strings. Use objects for structure and use maps for data. Use objects if you know all
            possible keys ahead of time. Use maps if you don't know all possible keys ahead of time.
        </p>
    </>
));
